...
<body>
    <div class="product-data">
        ...
        <section class="main">
            ...
            <form action="../php-processes/data-manipulation-processes.php" method="post" id="sub-categories">
                <?php
                ...
                <fieldset>
                    <div class="form-name">
                        <label>Sub-Categories Form</label>
                    </div>
                    <div class="field">
                    ...
                    <input type="submit" name="sub-categories" value="Submit Sub-Category" form="sub-categories">
                </fieldset>
            </form>
